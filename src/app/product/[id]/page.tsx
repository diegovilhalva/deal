...
import { getProductId } from "@/sanity/lib/client"
            ...
            <div className="container mx-auto py-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {product.image && (
                        <div className="bg-white rounded-2xl p-4 aspect-square overflow-hidden shadow-lg ">
                            <div className="relative  aspect-square">
                                <Image fill priority className="object-cover hover:scale-105 transition-transform duration-300"
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <AddToCardButton />
                        <div className="flex flex-col gap-3 mt-6 text-sm bg-white p-4 rounded-xl shadow-lg border border-gray-100">
